...
load_from = "/model/path/to/latest/pretrain/checkpoint"

# 根据自己的 GPU 情况，修改 batch size，YOLOv5-s 默认为 8卡 x 16bs
train_batch_size_per_gpu = 15
train_num_workers = 12  # 推荐使用 train_num_workers = nGPU x 4
...
metainfo = dict(
    classes=class_name,
    palette=[(220, 20, 60)]  # 画图时候的颜色，随便设置即可c
)
